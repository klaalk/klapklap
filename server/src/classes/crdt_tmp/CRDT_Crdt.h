...
public:
    ...
    vector<identifier> find_position_before(CRDT_pos pos);
    vector<identifier> find_position_after(CRDT_pos pos);
    vector<identifier> generate_position_between(vector<identifier> position_1,vector<identifier> position_2,vector<identifier> *new_position,int livello);
    strategy find_strategy(int level);
    int generate_identifier_between(identifier id_min, identifier id_max,strategy _strategy);
